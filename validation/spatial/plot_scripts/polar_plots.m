...
% PATHS
% ========================================================================
snolimits_path = '/Users/jordanherbert/Library/CloudStorage/OneDrive-UCB-O365/Boulder_Research/MASTER_Herbert/Projects/ML/500m_testing/aggregated_outputs/SWE';
parbal_path    = '/Volumes/PortableSSD/ParBal/lidar_validation';
uaswe_path     = '/Volumes/PortableSSD/UASWE/lidar_validation';
out_dir        = '/Users/jordanherbert/Library/CloudStorage/OneDrive-UCB-O365/Boulder_Research/MASTER_Herbert/Projects/ML/data_paper/dataset_comparisons/plot_save';
...
S_ca = load(fullfile(snolimits_path, 'CA_regional_SWE_500_IDW.mat'));    rf_ca = S_ca.rf_out;
S_co = load(fullfile(snolimits_path, 'rocky_regional_SWE_500_IDW.mat')); rf_co = S_co.rf_out;
