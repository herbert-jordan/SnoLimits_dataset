...
% J. Herbert
%
% Box plots of per-flight error metrics grouped by year
...
% PATHS
% ========================================================================
base_path = fileparts(fileparts(mfilename('fullpath')));  % = validation/spatial
data_dir  = fullfile(base_path, 'data');
out_dir   = fullfile(base_path, 'outputs');
if ~exist(out_dir, 'dir'), mkdir(out_dir); end

load(fullfile(data_dir, 'all_datasets_flight_errors.mat'))  % loads M
% ========================================================================
% CONFIG
% ========================================================================
models  = {'snolimits', 'uaswe', 'parbal', 'ucla'};
labels  = {'SnoLimits', 'UASWE', 'ParBal', 'UCLA SWE'};
years   = 2016:2019;
regions = {'CO', 'CA'};
...
for ri = 1:2
    ...
    for mi = 1:3
        ...
        pos_sub = pos_all(grp_ids);   % only positions for groups with data
...
% SAVE
% ========================================================================
out_file = fullfile(out_dir, 'error_boxplots_2016_2019.png');
